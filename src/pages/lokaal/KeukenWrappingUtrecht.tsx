...
export default function KeukenWrappingUtrecht() {
  return (
    <KeukenWrappingLokaal content={{
      ...
      werkwijzeIntro: "In 3 Stappen Uw Droomkeuken in Utrecht",
      whyTitle: "Bespaar tot 70% én Kies Duurzaam in Utrecht",
      materialenIntro: "Utrechters kiezen steeds vaker voor bewuste renovatie. Onze collectie van 300+ wrapfolies biedt voor iedere Utrechtse woning de perfecte match, of het nu gaat om een karakteristiek grachtenpand of een modern nieuwbouwappartement. Kras- en stootvast, onderhoudsvriendelijk en jaren mooi.",
