...
export default function KeukenWrappingNijmegen() {
  return (
    <KeukenWrappingLokaal content={{
      ...
      werkwijzeIntro: "In 4 Stappen Uw Droomkeuken in Nijmegen",
      whyTitle: "Bespaar tot 70% op Uw Keukenrenovatie in Nijmegen",
      materialenIntro: "Voor woningen in Nijmegen, van vooroorlogs tot modern, bieden wij de perfecte foliecollectie. Meer dan 300 afwerkingen waaronder klassieke houttinten die passen bij een karakteristiek pand, en strakke matte kleuren voor moderne appartementen. Alles krasbestendig en hittebestendig.",
