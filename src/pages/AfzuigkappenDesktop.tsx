...
export default function AfzuigkappenDesktop() {
  return (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 items-center">
            <div className="lg:col-span-6 space-y-8">
              <div className="inline-block border-l-2 border-primary pl-4">
                ...
                <p className="font-display text-lg italic text-gray-500">Geen nieuwe apparatuur, direct resultaat.</p>
              </div>
              ...
              <p className="text-gray-500 font-light leading-relaxed max-w-md pt-4">
                Een afzuigkap is vaak een beeldbepalend element in de keuken. Zonde als deze niet (meer) bij uw stijl past of vlekken vertoont. Wij wrappen uw afzuigkap vakkundig met premium folie voor een strakke, nieuwe look met topkwaliteit. Compleet nieuwe uitstraling, binnen één dag gefixt!
              </p>
             ...
             <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div>
                   ...
                   <p className="text-gray-400 mb-8 max-w-md">
                      Upload foto's van uw huidige afzuigkap en zie direct of dit geschikt is voor een strakke, nieuwe folie in uw droomstijl.
                   </p>
