...
export default function AchterwandenMobile() {
            ...
            <div className="lg:hidden flex flex-col h-[calc(100vh-140px)] justify-between pb-6 pt-5 relative z-10">
               <div className="border-b border-dark/10 pb-4 mb-6">
                ...
                <div className="mt-6">
                  <p className="text-sm text-gray-500 leading-relaxed max-w-xs">
                    Wij wrappen uw bestaande achterwand naar een hygiënische, naadloze showroomstaat. Geen sloopwerk, binnen 1 dag geregeld.
                  </p>
              ...
              <div className="relative w-full flex-1 min-h-[200px] shadow-lg overflow-hidden bg-gray-100 mt-4 mb-4 rounded-lg">
               ...
               <div className="relative z-20 flex flex-col gap-3">
                ...
                <a 
                  className="flex items-center justify-center text-xs font-bold tracking-widest uppercase border border-dark px-6 py-4 hover:bg-dark hover:text-white transition-all w-full uppercase" 
                  href="/projecten"
                >
