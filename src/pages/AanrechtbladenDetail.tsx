          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 items-center">
            <div className="lg:col-span-6 space-y-8">
              <div className="inline-block border-l-2 border-primary pl-4">
                <span className="block text-primary font-sans text-xs font-bold tracking-widest uppercase mb-2">Tot 70% Goedkoper Dan Vervangen</span>
                <p className="font-display text-lg italic text-gray-500">Nieuw aanrechtblad? Dat kan zonder sloopwerk.</p>
              </div>
              ...
              <p className="text-lg text-gray-600 font-light leading-relaxed max-w-md pt-4">
                Beschadigd, vergeeld of gewoon niet meer uw smaak? Vervangen kost al snel duizenden euro's en weken overlast. Wij wrappen uw bestaande aanrechtblad binnen één dag met krasvaste, hittebestendige folie — onzichtbaar van echt marmer, hout of beton. Resultaat: een splinternieuw blad, zonder de verbouwing.
              </p>
              {/* Trust Badges */}
